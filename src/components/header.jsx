...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-40">
      ...
      {/* Menu Mobile */}
      <nav
        className={`fixed top-0 right-0 h-full w-4/5 max-w-xs bg-black bg-opacity-95 z-50 flex flex-col items-center pt-20 space-y-8 text-xl font-semibold text-beige shadow-xl transition-transform duration-300 transform ${
